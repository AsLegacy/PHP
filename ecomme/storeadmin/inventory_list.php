...
if ($productCount > 0) {
	while($row = mysql_fetch_array($sql)){ 
			 ...
			 $product_list .= "Product ID: $id - <strong>$product_name</strong> - $price Dhs - <em>Added $date_added</em> &nbsp; &nbsp; &nbsp; <a href='inventory_edit.php?pid=$id'>edit</a> &bull; <a href='inventory_list.php?deleteid=$id'>delete</a><br />";
    }
} else {
...
<div align="center" id="mainWrapper">
  <?php include_once("../template_header.php");?>
    <div id="pageContent"><br />
      <div align="right" style="margin-right:32px"> <a href="http://localhost/ecomme/storeadmin/logout.php">Logout</a> &middot;
    ...
    <table width="90%" border="0" cellspacing="0" cellpadding="6">
      ...
      <tr>
        ...
        <td><label>
          ...
          <option value=""></option>
          <option value="Mat_Info">Matériel informatique</option>
          <option value="Cam_Surv">Caméra de Surveillance</option>
		  <option value="Four_Bur">Fourniture de Bureaux</option>
